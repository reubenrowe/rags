...
public class DerivationQuery implements IDerivationTerm {
    ...
    public DerivationQuery clone(ContextMapping context) {
        return new DerivationQuery(metaSyntax.clone(context), syntax.clone(context), context.getQueryMapping(id));
    }
    ...
    public IDerivationTerm findQuery(int queryID) {
        ...
        */
        ...
        if (dt1 != null && (((DerivationQuery) dt1).id == queryID)) return dt1;
        else if (dt2 != null && (((DerivationQuery) dt2).id == queryID)) return dt2;
        else return null;
