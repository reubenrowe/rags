...
public class ListEqualityExampleNew extends CommandLineInputBase {
    public Grammar CreateRAG() throws ArgumentMismatchException, RuleFunctionException, VariableNotFoundException {
        AnswerIdentifier nt_answer_Start_0 = new AnswerIdentifier("Start", 0);
        ...
        AnswerIdentifier tl_answer_4 = new AnswerIdentifier("T");
        AnswerIdentifier tl_answer_3 = new AnswerIdentifier("nil");
        ...
        AnswerIdentifier tl_answer_5 = new AnswerIdentifier("F");
        Answer a = new Answer(nt_answer_Start_0);
        ...
        poly6.add(new Answer(tl_answer_0));
        args4.add(poly6);
        Polynomial poly7 = new Polynomial();
        ArrayList<Polynomial> args5 = new ArrayList<>();
        Polynomial poly8 = new Polynomial();
        poly8.add(new Answer(tl_answer_1));
        args5.add(poly8);
        Polynomial poly9 = new Polynomial();
        ArrayList<Polynomial> args6 = new ArrayList<>();
        Polynomial poly10 = new Polynomial();
        poly10.add(new Answer(tl_answer_2));
        args6.add(poly10);
        Polynomial poly11 = new Polynomial();
        poly11.add(new Answer(tl_answer_3));
        args6.add(poly11);
        poly9.add(new Answer(nt_answer_Cons_2, args6));
        args5.add(poly9);
        poly7.add(new Answer(nt_answer_Cons_2, args5));
        args4.add(poly7);
        poly5.add(new Answer(nt_answer_Cons_2, args4));
        args3.add(poly5);
        poly4.add(new Answer(nt_answer_MemOf_1, args3));
        Polynomial poly12 = new Polynomial();
        poly12.add(vars.get(1));
        poly3.add(new Query(poly4, poly12));

        g.addRule(nt_answer_Start_0, new Rule(c, varSet, poly3, args1, conditions));
        //////////////////////////////////////////////////
        vars = new ArrayList<>();
        varSet = new VariableSet();
        args1 = new ArrayList<>();
        ...
        poly5.add(new Answer(tl_answer_5));
        ...
        poly2 = new Polynomial();
        poly2.add(new Answer(tl_answer_5));
        ...
        poly6.add(new Answer(tl_answer_5));
        ...
        poly4 = new Polynomial();
        poly4.add(new Answer(tl_answer_5));
    ...
    public static void main(String[] args) {
        ...
        performTest(new ListEqualityExampleNew(), args[0]);
    }
}